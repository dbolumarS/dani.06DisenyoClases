...
public class Empleadoejemplostatic implements Comparable<Empleadoejemplostatic> {
	//Atributos de clase
	public static Tiempo horaEntrada;
	public static Tiempo horaSalida;
	...
	public Empleadoejemplostatic( String DNI,String Nombre, int AingresaE, double SueldoB) {
		this.DNI = DNI;
		this.Nombre = Nombre;
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof Empleadoejemplostatic))
			return false;

		Empleadoejemplostatic E = (Empleadoejemplostatic) o;
	...
	public int compareTo (Empleadoejemplostatic e){
